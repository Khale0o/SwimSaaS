...
class ExpiredSubsScreen extends StatefulWidget {
  ...
  @override
  State<ExpiredSubsScreen> createState() => _ExpiredSubsScreenState();
}

class _ExpiredSubsScreenState extends State<ExpiredSubsScreen> {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Swimmers with expired subscriptions',
                      style: TextStyle(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  '${_searchQuery.isEmpty ? 'All' : 'Filtered'} expired swimmers',
                  style: TextStyle(
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          key: const PageStorageKey<String>('expired_subs_list_scroll'),
          padding: const EdgeInsets.fromLTRB(16, 16, 16, 32),
          itemCount: expiredSwimmers.length,
